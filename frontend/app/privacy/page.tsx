    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.content}>
                <section>
                    <p>개인정보처리방침</p>
                    <p>말랑이샵 은 (이하 '회사'는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.</p>
                ...
                <section>
                    ...
                    <p>ο 수집항목 : 이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 비밀번호 질문과 답변 , 자택 전화번호 , 자택 주소 , 휴대전화번호 , 이메일 , 직업 , 회사명 , 부서 , 직책 , 회사전화번호 , 취미 , 결혼여부 , 기념일 , 법정대리인정보 , 주민등록번호 , 서비스 이용기록 , 접속 로그 , 접속 IP 정보 , 결제기록 , 개인통관고유부호</p>
                ...
                <section>
                    <h2>1. 사이트 회원 가입 및 관리 : 회원가입시 본인여부 확인,서비스 이용 및 상담,공지사항 전달 , SNS 및 제 3자 계정을 연계하여 간편로그인 서비스 제공</h2>
                </section>
                <section>
                    <h2>2.재화 또는 서비스 제공: 물품배송, 서비스 제공, 콘텐츠 제공, 맞춤서비스 제공, 정산 및 환불</h2>
                </section>
                <section>
                    <h2>3.마케팅 및 광고: 웹 페이지 접속빈도 파악 또는 회원의 서비스 이용에 대한 통계, 이벤트 등 광고성 정보 전달</h2>
                </section>
                <section>
                    <h2>4. 호스팅사 이전 시 발생하는 모든 회원정보 이관 처리</h2>
                    <p>*회사의 서비스 이용 과정에서 서비스 이용기록, 방문기록, 불량 이용기록, IP 주소, 쿠키, 광고식별자 등의 정보가 자동으로 생성되어 수집될 수 있습니다.</p>
                    <p>*진행하는 이벤트에 따라 수집 항목이 상이할 수 있으므로 응모 시 별도 동의를 받으며, 목적 달성 즉시 파기합니다.</p>
                </section>
                <section>
                ...
                <section>
                    <h2>■ 제3자에 대한 제공 및 수집한 개인정보의 위탁</h2>
                </section>
                <section>
                    <h2>1. 회사는 고객의 개인정보를 '개인정보의 수집 및 이용목적'에서 고지한 범위를 넘어 이용하거나 타인 또는 타기업, 기관에 제공하지 않습니다.</h2>
                </section>
                <section>
                    <h2>2. 다음은 예외로 합니다.</h2>
                    ...
                    <p>상기사항에 의해 개인정보를 제공하는 경우에도 본래의 수집∙이용 목적에 반하여 무분별하게 정보가 제공되지 않도록 최대한 노력하겠으며 보다 나은 서비스 제공, 고객편의 제공 등 원활한 업무 수행을 위하여 아래와 같이 개인정보 처리 업무를 외부 전문업체에 위탁하여 운영하고 있습니다.</p>
                    <p>위탁업무 내용 및 수탁자</p>
                    <p>전산 시스템 구축 및 유지: (추후 도입 예정)</p>
                    <p>카카오알림톡/문자메시지 발송: (추후 도입 예정)</p>
                    <p>채널톡 마케팅 메시지 발송: (추후 도입 예정)</p>
                    <p>본인확인 : (추후 도입 예정)</p>
                    <p>상품 배송추적: (추후 도입 예정)</p>
                    <p>주문 상품의 배송:(추후 도입 예정)</p>
                    <p>결제 및 에스크로 서비스: 토스페이먼츠</p>
                ...
                <section>
                    <h2>■ 개인정보처리방침의 개정과 그 공지</h2>
                    <p>본 개인정보 처리방침을 개정할 경우에는 최소 7일전에 홈페이지 또는 이메일을 통해 변경 및 내용 등을 공지하도록 하겠습니다. 다만이용자의 소중한 권리 또는 의무에 중요한 내용 변경이 발생하는 경우 시행일로부터 최소 30일 전에 공지하도록 하겠습니다.</p>
                    <p>개인정보관리책임자 성명 : 홍길동</p>
                    <p>전화번호 : 02-1234-5678</p>
                    <p>이메일 : hello@mallangshop.kr</p>
                ...
                <section>
                    <p>1.대검찰청 사이버수사과 (cybercid.spo.go.kr)</p>
                </section>
                <section>
                    <p>2.경찰청 사이버테러대응센터 (www.ctrc.go.kr/02-392-0330)</p>
                </section>
                <section>
                    <p>3.개인정보침해신고센터 (privacy.kisa.or.kr / 국번 없이 118)</p>
                </section>
                <section>
                    <p>4.개인정보분쟁조정위원회 (kopico.go.kr / 1833-6972)</p>
                </section>
            </div>
        </div>
    );
