package com.mallanghwishop.backend.menu.adapter.in.web;

import com.mallanghwishop.backend.menu.application.port.in.GetMenuDetailUseCase;
import com.mallanghwishop.backend.menu.application.port.in.GetMenuImageListUseCase;
import com.mallanghwishop.backend.menu.application.port.in.GetMenuListUseCase;
import com.mallanghwishop.backend.menu.application.result.MenuDetailResult;
import com.mallanghwishop.backend.menu.application.result.MenuImageListResult;
import com.mallanghwishop.backend.menu.application.result.MenuListResult;
