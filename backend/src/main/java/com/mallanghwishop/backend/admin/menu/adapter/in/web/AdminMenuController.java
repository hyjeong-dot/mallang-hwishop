package com.mallanghwishop.backend.admin.menu.adapter.in.web;

import com.mallanghwishop.backend.admin.menu.adapter.in.web.dto.RegisterMenuRequest;
import com.mallanghwishop.backend.admin.menu.adapter.in.web.dto.UpdateMenuRequest;
import com.mallanghwishop.backend.admin.menu.adapter.in.web.dto.SaveMenuOptionsRequest;
import com.mallanghwishop.backend.admin.menu.application.port.in.DeleteMenuUseCase;
import com.mallanghwishop.backend.admin.menu.application.port.in.GetMenuListUseCase;
import com.mallanghwishop.backend.admin.menu.application.port.in.GetMenuUseCase;
import com.mallanghwishop.backend.admin.menu.application.port.in.RegisterMenuUseCase;
import com.mallanghwishop.backend.admin.menu.application.port.in.UpdateMenuUseCase;
import com.mallanghwishop.backend.admin.menu.application.port.in.ManageMenuImageUseCase;
import com.mallanghwishop.backend.admin.menu.application.port.out.MenuOptionPort;
import com.mallanghwishop.backend.admin.menu.adapter.in.web.dto.AddMenuImageRequest;
import com.mallanghwishop.backend.admin.menu.application.result.MenuImageListResult;
import com.mallanghwishop.backend.admin.menu.application.result.MenuOptionResult;
import com.mallanghwishop.backend.admin.menu.application.result.OptionItemResult;
import com.mallanghwishop.backend.admin.menu.application.result.MenuResult;
import com.mallanghwishop.backend.admin.menu.application.result.MenuListResult;
